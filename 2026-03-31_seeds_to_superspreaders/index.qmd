...
Lloyd-Smith's solution was statistical — fit a negative binomial, estimate k. That works when you have contact tracing data, which you have for SARS, measles, smallpox. You do not have that for wildlife pathogens. You have GPS collars.

Figure 2 is the machinery I'm replacing. They draw ν from a Gamma distribution — mathematically convenient, empirically reasonable. But it's an assumption. My framework derives the distribution of ν from movement data using EVT. When movement kernels have ξ > 0 — which they do, consistently, across taxa — the individual reproductive numbers follow a Lomax distribution. The Lomax is heavier-tailed than the Gamma. That changes the extinction probability surface and the outbreak size distribution in ways that matter for wildlife disease management.

Lloyd-Smith described the pattern. EVT explains the process.
:::


## What About Disease Ecology? {background-color="#0E2841" .white-text}
