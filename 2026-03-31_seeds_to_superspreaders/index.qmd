...
Estimated from GPS tracking

**Pathogen Dispersal Kernel**  
Movement × contact probability = transmission
*Camera traps*

**Outbreak Spread Kernel**  
Population-level dynamics - case numbers

::: {.key-insight}
The EVT shape parameter **$\xi$** from tracking data propagates predictive power through the entire cascade
:::
:::

::: {.column width="60%"}
::: {.placeholder-box-tall}
[PLACEHOLDER: Three-scale cascade diagram — individual kernel *to* pathogen kernel *to* outbreak kernel, with $\xi$ propagating through]
:::
:::
...
## Preliminary Simulations {background-color="#ffffff"}
